...
import { EMAIL_DEFAULT, NAME_DEFAULT, PASS_DEFAULT, PHONE_DEFAULT } from "../../shared/constants"
...
export class RegisterComponent implements OnInit {
    ...
    private initForm() : void {
        this.registerForm = this.fb.group({
            ...
            email: [EMAIL_DEFAULT, [Validators.required, Validators.email]], 

            password: [PASS_DEFAULT, [Validators.required, Validators.minLength(6)]],
            confirmPassword: [PASS_DEFAULT, [Validators.required]],
